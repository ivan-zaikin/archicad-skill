...
description: >-
  ...
  Используй этот скилл всегда, когда пользователь упоминает Archicad, BIM-проект,
  спецификации, экспликации помещений, подсчёт количеств/объёмов по модели —
  даже если слово «API» не прозвучало. Archicad must be running with a project
  open; works via HTTP on 127.0.0.1:19723.
---
